            ...
            try:
                ...
                if claims is not None:
                    ...
                    if user is not None:
                        ...
                        nutzen zu können.
                        """
                        user = adm.create_user(firstname, lastname, nickname,email, google_user_id)

                    print(request.method, request.path, "angefragt durch:", firstname, lastname, nickname, email)
